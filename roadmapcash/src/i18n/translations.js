export const translations = {
  en: {
    ...
    financialChart: {
      ...
      quest: {
        yourJourney: "Your Financial Journey",
        progress: "{completed} of {total} completed",
        stepOf: "Step {current} of {total}",
        completed: "Completed",
        startQuest: "Start This Quest",
        ...
        typeAction: "Action Item",
        typeHabit: "Weekly Habit",
        typeExpense: "Expense Review",
      },
    },
    ai: {
...
Respond in English.`,
  ...
  es: {
    ...
    financialChart: {
      ...
      quest: {
        yourJourney: "Tu Camino Financiero",
        progress: "{completed} de {total} completados",
        stepOf: "Paso {current} de {total}",
        completed: "Completado",
        startQuest: "Comenzar Esta Misión",
        reviewQuest: "Revisar Misión",
        previous: "Anterior",
        next: "Siguiente",
