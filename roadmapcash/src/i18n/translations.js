export const translations = {
  en: {
    ...
    financialChart: {
      ...
      currentProgress: "Savings Progress",
      ...
      portfolio: {
        ...
        qualityButton: "Analyze portfolio quality",
      ...
      interaction: {
        ...
        nextStepsDetail: "Complete this task to track your progress.",
...
Respond in English.`,
  ...
  es: {
    ...
    financialChart: {
      ...
      currentProgress: "Progreso de Ahorro",
      taskProgress: "Tareas Completadas",
      doneLabel: "Listo",
      ...
      interaction: {
        ...
        close: "Cerrar",
        challenge: "Desafío",
        nextSteps: "Qué puedes hacer",
        nextStepsDetail: "Completa esta tarea para registrar tu progreso.",
        tryDifferent: "Probar Otra",
        done: "Listo",
